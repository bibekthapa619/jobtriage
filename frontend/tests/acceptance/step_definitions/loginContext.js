...
Then('an error message {string} should be displayed above the email textfield', (msg) => {
  throw new Error('Not implemented yet');
});

Then('an error message {string} should be displayed above the password textfield', (msg) => {
  throw new Error('Not implemented yet');
});
